...
baseline <- readRDS("./data/env/envData_all.RDS")  # environmental data at 1 degree spatial resolution to obtain cell id number (from Bio-Oracle)
...
# Store Fidelity values of species to each bioregion (we'll use this for Figure 3!)
